  ...
  return (
    <main>
      <section className="relative xl:pt-28 xl:pb-10 px-10 text-grey">
        ...
        {/* Plans */}
        <section className="max-container pt-10 flex max-xl:flex-col flex-wrap justify-between">
      ...
      {/* slogan */}
      <section className="max-container max-xl:mx-5 py-10">
        <div className=" flex flex-wrap max-md:justify-around justify-between items-center py-16 px-12 bg-blue-50 rounded-lg max-w-[58rem] m-auto">
          <div className=" w-[70%] max-sm:text-center text-grey mb-5">
            <p className="text-4xl sm:text-[2.75rem] sm:leading-loose ">
